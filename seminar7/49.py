...
def find_farthest_orbit(orbits):
    elliptical_orbits = [x for x in orbits if x[0] != x[1]]
    areas_of_elliptical_orbits = [pi * x[0] * x[1] for x in elliptical_orbits]
    max_area_index = areas_of_elliptical_orbits.index(max(areas_of_elliptical_orbits))
    return elliptical_orbits[max_area_index]
